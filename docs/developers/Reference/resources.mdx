...
* <CopyButton title="llms.txt" filePath="../../llms.txt" />
* <CopyButton title="llms-full.txt (complete EigenLayer documentation)" filePath="../../llms-full.txt" />
* <CopyButton title="eigenlayer-contracts.md" filePath="../../eigenlayer-contracts.md" />
* <CopyButton title="hello-world-avs.md" filePath="../../hello-world-avs.md" />
