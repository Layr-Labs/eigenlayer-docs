...
> _Note: Please ensure that when adding your metadata_url link to operator configuration, the link is a publicly hosted link that can be accessed for registration._
