...
To restake on mainnet, visit the EigenLayer app at: [app.eigenlayer.xyz][ref1]
...
There will be a 7-day [withdrawal delay][ref2] that will serve as a security measure during the early stages of the EigenLayer mainnet, to optimize for the safety of assets. This withdrawal lag, which is common in staking protocols, is required when AVSs go live, as there is a lag to verify that activity associated with any AVS was completed successfully.

Read the [user guide to liquid restaking here][ref3] and the [user guide to native restaking here][ref4].

[ref1]: https://app.eigenlayer.xyz
[ref2]: withdrawal-delay.md
[ref3]: https://docs.eigenlayer.xyz/guides/liquid-restaking
[ref4]: https://docs.eigenlayer.xyz/restaking-guides/restaking-user-guide/native-restaking