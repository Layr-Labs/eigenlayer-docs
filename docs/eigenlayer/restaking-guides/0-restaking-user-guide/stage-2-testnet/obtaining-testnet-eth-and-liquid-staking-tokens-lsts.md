...
In this guide, we will show you how to use a Holesky faucet to load your wallet with [testnet ETH][ref1] and how to obtain Holesky Liquid Staking Tokens so you can start testing liquid restaking.
...
- Add Holesky network to your Web3 wallet (example instructions [here][ref2]) if it does not automatically appear.
...
- Import the [Lido and stETH token (proxy)][ref4] address for Holesky stETH token to your web3 wallet to view your token balance.
- Note: Lido on Holesky staking is rate-limited to 1500 holETH per rolling 24hr window.

## Swap holETH for ETHx (Stader)​
- Visit the Stader Holesky proxy contract’s Write as Proxy contract in Etherscan here: [0x7F09ceb3874F5E35Cd2135F56fd4329b88c5d119][ref5].
...
- Visit [testnet.ankr.com/staking/stake/ethereum][ref6].
...
- Visit the [Stakewise Holesky Vault Marketplace][ref7].
...
- Visit the Liquid Staked ETH LsETH proxy contract’s Write as Proxy contract in Etherscan here: [0x1d8b30cC38Dba8aBce1ac29Ea27d9cFd05379A09][ref8].
- Click **Connect to Web3** to connect your web3 wallet.
...
- Add Holesky to your Web3 wallet (example instructions [here][ref9]).
...
- Open the Frax Finance Mint app: [app.frax.finance/frxeth/mint][ref10] .
...
- Visit the MantleETH proxy contract’s Write as Proxy contract in Etherscan here: [0xbe16244EAe9837219147384c8A7560BA14946262][ref11].
- Click **Connect to Web3** to connect your web3 wallet.
...
[ref1]: https://ethereum.org/en/developers/docs/networks/#ethereum-testnets
[ref2]: https://www.coingecko.com/learn/holesky-testnet-eth#add-the-holesky-testnet-to-metamask
[ref3]: https://holesky-faucet.pk910.de
[ref4]: https://docs.lido.fi/deployed-contracts/holesky/
[ref5]: https://holesky.etherscan.io/address/0x7F09ceb3874F5E35Cd2135F56fd4329b88c5d119#writeProxyContract
[ref6]: https://testnet.ankr.com/staking/stake/ethereum/
[ref7]: https://app.stakewise.io/vaults?networkId=holesky
[ref8]: https://holesky.etherscan.io/address/0x1d8b30cC38Dba8aBce1ac29Ea27d9cFd05379A09#writeProxyContract
[ref9]: https://www.coingecko.com/learn/holesky-testnet-eth#add-the-holesky-testnet-to-metamask
[ref10]: https://app.frax.finance/frxeth/mint
[ref11]: https://holesky.etherscan.io/address/0xbe16244EAe9837219147384c8A7560BA14946262#writeProxyContract