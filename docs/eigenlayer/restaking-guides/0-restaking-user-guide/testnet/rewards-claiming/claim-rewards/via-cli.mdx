...
:::info
If you already have your keys in either either of the supported key management options, you can skip this step.
:::
...
If you are using fireblocks or web3 wallet check the command help for the respective key management backend.
```bash
