...
- EigenLayer **Rewards** enables AVSs to make rewards distributions to stakers and operators. Operators earn rewards by opting in to AVSs that make RewardsSubmissions to the RewardsCoordinator, a core protocol contract.
