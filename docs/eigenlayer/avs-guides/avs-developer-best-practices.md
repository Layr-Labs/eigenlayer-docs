...
- Use Minimal Base Images
    - Use [ko Go containers][ref1] or similar to build distro-less minimal images. This reduces the attack surface significantly!
...
- AVS team should [sign their images][ref2] for any releases, including upgrades
...
For key management, refer to the new location for the docs on [Key Security Considerations for Developers][ref3].
[ref1]: https://ko.build/
[ref2]: https://docs.docker.com/engine/security/trust/
[ref3]: ./key-management/developers.md