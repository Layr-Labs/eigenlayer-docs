...
<Tabs groupId="network">
  <TabItem value="mainnet" label="Mainnet">
    ...
    - Minimum stake floor: Each operator must have at least 96 ETH. 
...
Details about how these requirements are enforced and the process by which DA nodes join a quorum for which they are eligible can be found at the [Registration Protocol Overview](../registration-protocol/).
